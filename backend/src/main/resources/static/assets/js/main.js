...
$(window).on("load", function () {
    $(".pagination-bar__list:eq(0)").find("a").text("主面板");
    $(".pagination-bar__list:eq(2)").find("a").text($("title").text());
    console.log($("title").text());
    if($("title").text() != "主面板"){
        //根据各个页面选择打开哪个导航栏
        $("#main-page").removeClass("active-page");
        if($("title").text() == "博客列表"){
            $(".pagination-bar__list:eq(1)").find("a").text("博客");
            $("#article-ul").removeClass("mx-sidenav__sub--hide");
            $("#article-li").addClass("active-page");
            $("#article-list-a").addClass("active-page");
        }
        else if($("title").text() == "写博客"){
            $(".pagination-bar__list:eq(1)").find("a").text("博客");
            $("#article-ul").removeClass("mx-sidenav__sub--hide");
            $("#article-li").addClass("active-page");
