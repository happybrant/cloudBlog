...
import com.framework.backend.dao.ArticleMapper;
...
public class ArticleService {
  ...
  @Autowired private com.framework.backend.service.SettingService settingService;
   ...
   * @return
   */
  public MyPage<Article> findArticlePager(ArticleQuery articleQuery) {
    MyPage<Article> articlePage =
        new MyPage<>(articleQuery.getPageIndex(), articleQuery.getPageSize());
    // 获取博客列表
